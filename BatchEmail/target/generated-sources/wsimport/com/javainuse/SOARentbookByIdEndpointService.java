 ...
 * 
 */
@WebServiceClient(name = "SOARentbookByIdEndpointService", targetNamespace = "http://javainuse.com", wsdlLocation = "http://localhost:8085/javainuse/ws/helloworld.wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOARENTBOOKBYIDENDPOINTSERVICE_QNAME = new QName("http://javainuse.com", "SOARentbookByIdEndpointService");
    ...
    public SOARentbookByIdEndpoint getSOARentbookByIdEndpoint() {
        return super.getPort(new QName("http://javainuse.com", "SOARentbookByIdEndpoint"), SOARentbookByIdEndpoint.class);
    }
    ...
    public SOARentbookByIdEndpoint getSOARentbookByIdEndpoint(WebServiceFeature... features) {
        return super.getPort(new QName("http://javainuse.com", "SOARentbookByIdEndpoint"), SOARentbookByIdEndpoint.class, features);
    }
