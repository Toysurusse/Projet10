 ...
 * 
 */
@WebServiceClient(name = "SOAUserTestEndpointService", targetNamespace = "http://javainuse.com", wsdlLocation = "http://localhost:8085/javainuse/ws/helloworld.wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAUSERTESTENDPOINTSERVICE_QNAME = new QName("http://javainuse.com", "SOAUserTestEndpointService");
    ...
    public SOAUserTest getSOAUserTestEndpoint() {
        return super.getPort(new QName("http://javainuse.com", "SOAUserTestEndpoint"), SOAUserTest.class);
    }
    ...
    public SOAUserTest getSOAUserTestEndpoint(WebServiceFeature... features) {
        return super.getPort(new QName("http://javainuse.com", "SOAUserTestEndpoint"), SOAUserTest.class, features);
    }
