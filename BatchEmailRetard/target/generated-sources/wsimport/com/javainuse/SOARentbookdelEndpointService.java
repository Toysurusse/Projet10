 ...
 * 
 */
@WebServiceClient(name = "SOARentbookdelEndpointService", targetNamespace = "http://javainuse.com", wsdlLocation = "http://localhost:8085/javainuse/ws/helloworld.wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOARENTBOOKDELENDPOINTSERVICE_QNAME = new QName("http://javainuse.com", "SOARentbookdelEndpointService");
    ...
    public SOARentbookdel getSOARentbookdelEndpoint() {
        return super.getPort(new QName("http://javainuse.com", "SOARentbookdelEndpoint"), SOARentbookdel.class);
    }
    ...
    public SOARentbookdel getSOARentbookdelEndpoint(WebServiceFeature... features) {
        return super.getPort(new QName("http://javainuse.com", "SOARentbookdelEndpoint"), SOARentbookdel.class, features);
    }
