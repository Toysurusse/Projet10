...
<div>
    ...
    <div class="container-fluid col-sm-4">
        <s:form theme="simple" action="userUpdate">
            <div class="row">
                <label for="user.userid" class="starter-template col-sm-12"> User ID :</label>
                <s:textfield cssClass="form-control" placeholder="Login" name="user.userid" label="userid"
            ...
            <s:submit method="userUpdate" value="Valider" cssClass="btn btn-primary center-block"/>
                </div>
            </div>
            <br>
        </s:form>
