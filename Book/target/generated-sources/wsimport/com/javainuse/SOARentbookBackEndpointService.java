 ...
 * 
 */
@WebServiceClient(name = "SOARentbookBackEndpointService", targetNamespace = "http://javainuse.com", wsdlLocation = "http://localhost:8085/javainuse/ws/helloworld.wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOARENTBOOKBACKENDPOINTSERVICE_QNAME = new QName("http://javainuse.com", "SOARentbookBackEndpointService");
    ...
    public SOARentbookBack getSOARentbookBackEndpoint() {
        return super.getPort(new QName("http://javainuse.com", "SOARentbookBackEndpoint"), SOARentbookBack.class);
    }
    ...
    public SOARentbookBack getSOARentbookBackEndpoint(WebServiceFeature... features) {
        return super.getPort(new QName("http://javainuse.com", "SOARentbookBackEndpoint"), SOARentbookBack.class, features);
    }
