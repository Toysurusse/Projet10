 ...
 * 
 */
@WebServiceClient(name = "SOABookEndpointService", targetNamespace = "http://library.com", wsdlLocation = "http://192.168.0.14:8082/spring-boot-soap-0.0.1-SNAPSHOT/library/ws/library.wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOABOOKENDPOINTSERVICE_QNAME = new QName("http://library.com", "SOABookEndpointService");
    ...
    public SOABookEndpoint getSOABookEndpoint() {
        return super.getPort(new QName("http://library.com", "SOABookEndpoint"), SOABookEndpoint.class);
    }
    ...
    public SOABookEndpoint getSOABookEndpoint(WebServiceFeature... features) {
        return super.getPort(new QName("http://library.com", "SOABookEndpoint"), SOABookEndpoint.class, features);
    }
